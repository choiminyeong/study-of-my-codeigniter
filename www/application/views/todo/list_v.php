		...
		<nav id="gnb">
			...
			<article id="board_area">
				...
				<table cellspacing="0" cellpadding="0" class="table table-striped">
					...
					<tbody>
						<?php
						 ...
						 <tr>
					 		...
					 		<td><a rel="external" href="/index.php/main/view/<?php echo $lt->id;?>"> <?php echo $lt->content;?></a></td>
					...
					<tfoot>
						<tr>
							<th colspan="4"><a href="/index.php/main/write/" class="btn btn-success">쓰기</a></th>
						</tr>
					</tfoot>
				</table>
				<div><p></p></div>
